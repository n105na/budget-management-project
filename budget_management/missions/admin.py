...
class MissionAdmin(admin.ModelAdmin):
    list_display = ("mission_nature", "destination_wilaya", "transport_type", "funding_type", "date_departure", "date_arrival")
...
class MissionPersonnelAdmin(admin.ModelAdmin):
    list_display = ("personnel", "mission", "transport_payment", "meal_payment", "lodging_payment", "total_payment")
